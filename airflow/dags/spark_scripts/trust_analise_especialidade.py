...
dfResult2023 = (dfCadastro
     ...
     .select(dfCadastro.CRM, dfCadastro.ESPECIALIDADE_1, df_visitas.ID_VISITA, df_presc.PX1, df_presc.ANO, df_presc.MES)
     .filter(fn.col("ANO") == 2023)
     .groupby("ESPECIALIDADE_1", "ANO", "MES").agg(fn.countDistinct("CRM").alias("QTD_CRM_2023"), fn.count("ID_VISITA").alias("QTD_VISITA_2023"), fn.sum("PX1").alias("PX_2023"))
)
...
dfResult2022 = (dfCadastro
     ...
     .groupby("ESPECIALIDADE_1", "ANO", "MES").agg(fn.countDistinct("CRM").alias("QTD_CRM_2022"), fn.count("ID_VISITA").alias("QTD_VISITA_2022"), fn.sum("PX1").alias("PX_2022"))
)            

dfResult = (dfResult2023
    .join(dfResult2022, (dfResult2023.ESPECIALIDADE_1 == dfResult2022.ESPECIALIDADE_1) & (dfResult2023.MES == dfResult2022.MES), "full")
...
(dfResult
 ...
 .format('parquet')
 .mode('overwrite')
 .save('s3a://trust/analise_especialidade')
 )